<p align="center">
  <picture>
    ...
    <img src="docs/assets/cover-light.svg" alt="systemd Service Generator — Generate A Systemd .Service Unit File, in the Terminal Workbench style" width="100%">
  </picture>
</p>

<p align="center">
  <a href="https://real-fruit-snacks.github.io/systemd-service-generator/"><strong>Live site</strong></a> ·
...
Fill in the fields and get a complete systemd .service unit — [Unit]/[Service]/[Install] sections, restart policy, and the install commands. Styled with the
...
**Offline / airgapped:** grab the zip from the [latest release](https://github.com/Real-Fruit-Snacks/systemd-service-generator/releases/latest)
