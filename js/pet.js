(function () {
  ...
  function readSize() {
    var s = parseInt(localStorage.getItem("svc-pet-size"), 10);
  ...
  var COLOR_COUNT = 6;
  var petColor = 0;
  try { petColor = parseInt(localStorage.getItem("svc-pet-color"), 10) || 0; }
  ...
  function cyclePetColor() {
    ...
    applyPetColor();
    try {
      if (petColor) localStorage.setItem("svc-pet-color", String(petColor));
      else localStorage.removeItem("svc-pet-color");
    } catch (e) { /* private mode */ }
  }
  ...
  function applyOpacity() {
    var o = parseInt(localStorage.getItem("svc-pet-opacity"), 10);
    if (!(o >= 15 && o <= 100)) o = 70;
    document.documentElement.style.setProperty("--pet-base-opacity", (o / 100).toFixed(3));
  }
  function readCfg() {
    cfgNap = boolKey("svc-pet-nap", true);
    cfgFlee = boolKey("svc-pet-flee", true);
    cfgRead = boolKey("svc-pet-read", true);
    cfgTricks = boolKey("svc-pet-tricks", true);
    cfgSpeech = boolKey("svc-pet-speech", false);
    var c = parseInt(localStorage.getItem("svc-pet-color"), 10);
